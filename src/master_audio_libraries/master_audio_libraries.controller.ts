...
import { UpdateMasterAudioLibraryDto } from './dto';
import { CreateMasterAudioLibraryDto } from './dto/create.dto';
...
@ApiTags('master-audio-libraries')
@ApiResponse({
  status: HttpStatus.INTERNAL_SERVER_ERROR,
  description: 'Server Error!',
})
@Controller('master-audio-libraries')
export class MasterAudioLibrariesController {
  constructor(private readonly service: MasterAudioLibrariesService) {}

  /**
   * Record create
   * @Body {CreateMasterAudioLibraryDto} data
   * @user {IUser} user
   * @returns {Promise<>}
   */
  ...
  @HasPermissions([PermissionTitle.MASTER_AUDIO_LIBRARY_CREATE])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Post()
  create(@User() user: IUser, @Body() data: CreateMasterAudioLibraryDto) {
    try {
  ...
  @HasPermissions([PermissionTitle.MASTER_AUDIO_LIBRARY_UPDATE])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Patch(':id')
  public async update(
    @User() user: IUser,
    @Param('id') id: number,
    @Body() data: UpdateMasterAudioLibraryDto,
  ) {
    try {
  ...
  @HasPermissions([PermissionTitle.MASTER_AUDIO_LIBRARY_DELETE])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Delete(':id')
