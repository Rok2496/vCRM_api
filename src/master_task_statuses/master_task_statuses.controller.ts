...
import {
  CreateMasterTaskStatusDto as CreateDto,
  UpdateMasterTaskStatusDto as UpdateDto,
} from './dto';
...
@Controller('master-task-statuses')
export class MasterTaskStatusesController {
  ...
  @HasPermissions([PermissionTitle.MASTER_TASK_STATUS_CREATE])
  ...
  @UsePipes(new ValidationPipe(true))
  @UsePipes(new TrimPipe())
  @HasPermissions([PermissionTitle.MASTER_TASK_STATUS_UPDATE])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Patch(':id')
  async update(
    @Param('id') id: number,
  ...
  @ApiBearerAuth()
  @UsePipes(new ValidationPipe(true))
  @HasPermissions([PermissionTitle.MASTER_TASK_STATUS_DELETE])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Delete(':id')
