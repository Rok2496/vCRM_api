...
@Controller('app-user-custom-permissions')
export class ApplicationUserCustomPermissionsController {
  ...
  @HasPermissions([PermissionTitle.APP_USER_CUSTOM_PERMISSION_CREATE])
  ...
  @UsePipes(new ValidationPipe(true))
  @UsePipes(new TrimPipe())
  @HasPermissions([PermissionTitle.APP_USER_CUSTOM_PERMISSION_UPDATE])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Patch(':id')
  async update(
    @Param('id') id: number,
  ...
  @ApiBearerAuth()
  @UsePipes(new ValidationPipe(true))
  @HasPermissions([PermissionTitle.APP_USER_CUSTOM_PERMISSION_DELETE])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Delete(':id')
