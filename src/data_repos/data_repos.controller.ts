...
import {
  CreateDataReposDto as CreateDto,
  UpdateDataReposDto as UpdateDto,
} from './dto';
import { PermissionTitle } from 'src/common/constant';
import { PermissionsGuard } from 'src/common/guards';

@Controller('data-repos')
export class DataReposController {
  ...
  @HasPermissions([PermissionTitle.DATA_REPO_CREATE])
  ...
  @UsePipes(new ValidationPipe(true))
  @UsePipes(new TrimPipe())
  @HasPermissions([PermissionTitle.DATA_REPO_UPDATE])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Patch(':id')
  async update(
    @Param('id') id: number,
  ...
  @ApiBearerAuth()
  @UsePipes(new ValidationPipe(true))
  @HasPermissions([PermissionTitle.DATA_REPO_DELETE])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Delete(':id')
