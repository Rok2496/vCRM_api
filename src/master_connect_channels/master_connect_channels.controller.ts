...
import {
  CreateMasterConnectChannelDto as CreateDto,
  UpdateMasterConnectChannelDto as UpdateDto,
} from './dto';
...
@Controller('master-connect-channels')
export class MasterConnectChannelsController {
  ...
  @HasPermissions([
    PermissionTitle.MASTER_CONNECT_MESSAGING_CHANNELS_TYPE_CREATE,
  ])
  ...
  @UsePipes(new TrimPipe())
  @HasPermissions([
    PermissionTitle.MASTER_CONNECT_MESSAGING_CHANNELS_TYPE_UPDATE,
  ])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Patch(':id')
  async update(
  ...
  @UsePipes(new ValidationPipe(true))
  @HasPermissions([
    PermissionTitle.MASTER_CONNECT_MESSAGING_CHANNELS_TYPE_DELETE,
  ])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Delete(':id')
