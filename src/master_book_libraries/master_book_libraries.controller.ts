...
import { UpdateMasterBookLibraryDto } from './dto';
import { CreateMasterBookLibraryDto } from './dto/create.dto';
...
@ApiTags('master-book-libraries')
@ApiResponse({
  status: HttpStatus.INTERNAL_SERVER_ERROR,
  description: 'Server Error!',
})
@Controller('master-book-libraries')
export class MasterBookLibrariesController {
  constructor(private readonly service: MasterBookLibrariesService) {}

  /**
   * Record create
   * @Body {CreateMasterBookLibraryDto} data
   * @user {IUser} user
   * @returns {Promise<>}
   */
  ...
  @HasPermissions([PermissionTitle.MASTER_BOOK_LIBRARY_CREATE])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Post()
  create(@User() user: IUser, @Body() data: CreateMasterBookLibraryDto) {
    try {
  ...
  @HasPermissions([PermissionTitle.MASTER_BOOK_LIBRARY_UPDATE])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Patch(':id')
  public async update(
    @User() user: IUser,
    @Param('id') id: number,
    @Body() data: UpdateMasterBookLibraryDto,
  ) {
    try {
  ...
  @HasPermissions([PermissionTitle.MASTER_BOOK_LIBRARY_DELETE])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Delete(':id')
