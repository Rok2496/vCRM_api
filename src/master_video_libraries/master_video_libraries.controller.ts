...
import {
  CreateMasterVideoLibraryDto as CreateDto,
  UpdateMasterVideoLibraryDto as UpdateDto,
} from './dto';
...
@Controller('master-video-libraries')
export class MasterVideoLibrariesController {
  constructor(private readonly service: MasterVideoLibrariesService) {}
  ...
  @HasPermissions([PermissionTitle.MASTER_VIDEO_LIBRARY_CREATE])
  ...
  @UsePipes(new ValidationPipe(true))
  @UsePipes(new TrimPipe())
  @HasPermissions([PermissionTitle.MASTER_VIDEO_LIBRARY_UPDATE])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Patch(':id')
  async update(
    @Param('id') id: number,
  ...
  @ApiBearerAuth()
  @UsePipes(new ValidationPipe(true))
  @HasPermissions([PermissionTitle.MASTER_VIDEO_LIBRARY_DELETE])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Delete(':id')
