...
export class ApplicationPermissionsController {
  ...
  @HasPermissions([PermissionTitle.APP_PERMISSION_CREATE])
  ...
  @UsePipes(new ValidationPipe(true))
  @UsePipes(new TrimPipe())
  @HasPermissions([PermissionTitle.APP_PERMISSION_UPDATE])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Patch(':id')
  async update(
    @Param('id') id: number,
  ...
  @ApiBearerAuth()
  @UsePipes(new ValidationPipe(true))
  @HasPermissions([PermissionTitle.APP_PERMISSION_DELETE])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Delete(':id')
   ...
   */
  @ApiOperation({ summary: 'Seed permissions' })
  @ApiHeader({ name: 'Authorization', description: 'Bearer Token' })
  @ApiBearerAuth()
  @UsePipes(new ValidationPipe(true))
  // @UseGuards(JwtAuthGuard, PermissionsGuard)
