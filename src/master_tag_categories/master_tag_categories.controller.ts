...
import {
  CreateMasterTagCategoryDto as CreateDto,
  UpdateMasterTagCategoryDto as UpdateDto,
} from './dto';
...
@Controller('master-tag-categories')
export class MasterTagCategoriesController {
  ...
  @HasPermissions([PermissionTitle.MASTER_TAG_CATEGORY_CREATE])
  ...
  @UsePipes(new ValidationPipe(true))
  @UsePipes(new TrimPipe())
  @HasPermissions([PermissionTitle.MASTER_TAG_CATEGORY_UPDATE])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Patch(':id')
  async update(
    @Param('id') id: number,
  ...
  @ApiBearerAuth()
  @UsePipes(new ValidationPipe(true))
  @HasPermissions([PermissionTitle.MASTER_TAG_CATEGORY_DELETE])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Delete(':id')
