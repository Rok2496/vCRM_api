...
@ApiTags('Voter Tags')
@Controller('voter-tags')
export class VoterTagsController {
  ...
  @ApiBearerAuth()
  @ApiResponse({ status: 201, description: 'Voter tag created successfully' })
  ...
  @ApiHeader({ name: 'Authorization', description: 'Bearer Token' })
  @ApiBearerAuth()
  @ApiResponse({ status: 200, description: 'Return list of voter tags' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 403, description: 'Forbidden - insufficient permissions' })
  @UsePipes(new ValidationPipe(true))
  ...
  @ApiHeader({ name: 'Authorization', description: 'Bearer Token' })
  @ApiBearerAuth()
  @ApiResponse({ status: 200, description: 'Return count of voter tags' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 403, description: 'Forbidden - insufficient permissions' })
  @UsePipes(new ValidationPipe(true))
  @HasPermissions([PermissionTitle.VOTER_COUNT])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Get('count')
  ...
  @ApiHeader({ name: 'Authorization', description: 'Bearer Token' })
  @ApiBearerAuth()
  @ApiResponse({ status: 200, description: 'Return single voter tag' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 403, description: 'Forbidden - insufficient permissions' })
  @ApiResponse({ status: 404, description: 'Voter tag not found' })
  @UsePipes(new ValidationPipe(true))
  @HasPermissions([PermissionTitle.VOTER_READ])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Get(':id')
  ...
  @ApiHeader({ name: 'Authorization', description: 'Bearer Token' })
  @ApiBearerAuth()
  @ApiResponse({ status: 200, description: 'Voter tag updated successfully' })
  @ApiResponse({ status: 400, description: 'Bad request' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 403, description: 'Forbidden - insufficient permissions' })
  @ApiResponse({ status: 404, description: 'Voter tag not found' })
  ...
  @ApiHeader({ name: 'Authorization', description: 'Bearer Token' })
  @ApiBearerAuth()
  @ApiResponse({ status: 200, description: 'Voter tag deleted successfully' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 403, description: 'Forbidden - insufficient permissions' })
  @ApiResponse({ status: 404, description: 'Voter tag not found' })
  @UsePipes(new ValidationPipe(true))
