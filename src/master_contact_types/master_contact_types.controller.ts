...
import {
  CreateMasterContactTypeDto as CreateDto,
  UpdateMasterContactTypeDto as UpdateDto,
} from './dto';
...
@Controller('master-contact-types')
export class MasterContactTypesController {
  ...
  @HasPermissions([PermissionTitle.MASTER_CONTACT_TYPE_CREATE])
  ...
  @UsePipes(new ValidationPipe(true))
  @UsePipes(new TrimPipe())
  @HasPermissions([PermissionTitle.MASTER_CONTACT_TYPE_UPDATE])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Patch(':id')
  async update(
    @Param('id') id: number,
  ...
  @ApiBearerAuth()
  @UsePipes(new ValidationPipe(true))
  @HasPermissions([PermissionTitle.MASTER_CONTACT_TYPE_DELETE])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Delete(':id')
