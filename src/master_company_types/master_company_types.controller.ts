...
import {
  CreateMasterCompanyTypeDto as CreateDto,
  UpdateMasterCompanyTypeDto as UpdateDto,
} from './dto';
...
@Controller('master-company-types')
export class MasterCompanyTypesController {
  ...
  @HasPermissions([PermissionTitle.MASTER_COMPANY_TYPE_CREATE])
  ...
  @UsePipes(new ValidationPipe(true))
  @UsePipes(new TrimPipe())
  @HasPermissions([PermissionTitle.MASTER_COMPANY_TYPE_UPDATE])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Patch(':id')
  async update(
    @Param('id') id: number,
  ...
  @ApiBearerAuth()
  @UsePipes(new ValidationPipe(true))
  @HasPermissions([PermissionTitle.MASTER_COMPANY_TYPE_DELETE])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Delete(':id')
