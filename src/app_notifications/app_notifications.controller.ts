...
import { PermissionsGuard } from 'src/common/guards/permissions.guards';
import { PermissionTitle } from 'src/common/constant';

@Controller('app-notifications')
export class ApplicationNotificationsController {
  ...
  @HasPermissions([PermissionTitle.APP_NOTIFICATION_CREATE])
  ...
  @UsePipes(new ValidationPipe(true))
  @UsePipes(new TrimPipe())
  @HasPermissions([PermissionTitle.APP_NOTIFICATION_UPDATE])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Patch(':id')
  async update(
    @Param('id') id: number,
  ...
  @ApiBearerAuth()
  @UsePipes(new ValidationPipe(true))
  @HasPermissions([PermissionTitle.APP_NOTIFICATION_DELETE])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Delete(':id')
