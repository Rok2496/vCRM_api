...
import {
  CreateMasterCountryDto as CreateDto,
  UpdateMasterCountryDto as UpdateDto,
} from './dto';
...
export class MasterCountriesController {
  ...
  @HasPermissions([PermissionTitle.MASTER_COUNTRY_CREATE])
  ...
  @UsePipes(new ValidationPipe(true))
  @UsePipes(new TrimPipe())
  @HasPermissions([PermissionTitle.MASTER_COUNTRY_UPDATE])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Patch(':id')
  async update(
    @Param('id') id: number,
  ...
  @ApiBearerAuth()
  @UsePipes(new ValidationPipe(true))
  @HasPermissions([PermissionTitle.MASTER_COUNTRY_DELETE])
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Delete(':id')
